...
AUDIT_LOG_APP_NAME = getattr(settings, 'AUDIT_LOG_APP_NAME')
AUDIT_LOG_LOGSTASH_HOST = getattr(settings, 'AUDIT_LOG_LOGSTASH_HOST')
AUDIT_LOG_LOGSTASH_PORT = getattr(settings, 'AUDIT_LOG_LOGSTASH_PORT')
